...
public class AddControllerTest {
    ...
    public void checkLoadAddController() throws Exception {
        assertThat(addController).isNotNull();
    }
    ...
    @Test
    public void addPageWithGuest() throws Exception {
        this.mockMvc.perform(get("/add"))
                .andDo(print())
    ...
    @Test
    @WithUserDetails(value = "admin")
    public void postRequestAddTest() throws Exception {
        this.mockMvc.perform(post("/add")
                ...
                .andDo(print())
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/home?successfullyAdded"));
        ...
        assertEquals(suttyRead4.getBirthday(), Date.valueOf("1987-04-06"));
        assertEquals(suttyRead4.getRole(), new Role(2L, "USER"));
    }

    @Test
    @WithUserDetails(value = "admin")
    public void addAlreadyExistUserWithThisLoginTest() throws Exception {
        this.mockMvc.perform(post("/add")
        ...
        assertEquals("Login should be exist", suttyRead1.getLogin(), "SuttyRead1");
    ...
    @Test
    @WithUserDetails(value = "admin")
    public void addUserWithIncorrectDataTest() throws Exception {
        this.mockMvc.perform(post("/add")
                .param("login", "SuttyRead6")
                .param("password", "Sut")
                ...
                .andDo(print())
                .andExpect(status().is2xxSuccessful());
        User suttyRead6 = userService.findUserByLogin("SuttyRead6");
        assertNull("Invalid data entered", suttyRead6);
    }
